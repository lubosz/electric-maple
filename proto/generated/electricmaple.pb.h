...
typedef enum _em_proto_EnvBlendMode {
    em_proto_EnvBlendMode_UNKNOWN = 0,
    em_proto_EnvBlendMode_OPAQUE = 1,
    em_proto_EnvBlendMode_ADDITIVE = 2
} em_proto_EnvBlendMode;
...
#define _em_proto_EnvBlendMode_MIN em_proto_EnvBlendMode_UNKNOWN
#define _em_proto_EnvBlendMode_MAX em_proto_EnvBlendMode_ADDITIVE
#define _em_proto_EnvBlendMode_ARRAYSIZE ((em_proto_EnvBlendMode)(em_proto_EnvBlendMode_ADDITIVE+1))
...
#define em_proto_DownFrameDataMessage_env_blend_mode_ENUMTYPE em_proto_EnvBlendMode
